...
def classAsTextToClassAsInt(classAsText):
    ...
    if classAsText == 'traffic_light':
        return 1
    if classAsText == 'traffic_lights':
        return 1
    if classAsText == 'park_etmek_yasak':
        return 1
    if classAsText == 'ileri_ve_sola_donus':
        return 1
    if classAsText == 'virajli_yol':
        return 1
    if classAsText == 'hiz_siniri':
        return 1
    if classAsText == 'daralan_yol':
        return 1
    if classAsText == 'arac_giremez':
        return 1
    if classAsText == 'yol_ver':
        return 1
    if classAsText == 'giris_yasak':
        return 1
    if classAsText == 'dur':
        return 1
    if classAsText == 'sola_don':
        return 1
    if classAsText == 'ileri_ve_saga_donus':
        return 1
    if classAsText == 'yaya_gecidi':
        return 1
    if classAsText == 'saga_don':
        return 1
    else:
